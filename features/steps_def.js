...
Given('Foundry has the system {string} installed', { timeout: 30000 }, async system => {
  ...
  await streamPipeline(download.body, fs.createWriteStream(`${FOUNDRY_PATH}/${game.name}.zip`))
});
